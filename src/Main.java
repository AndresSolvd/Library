...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        library.setAddress("Library Address: 4 Privet Drive, Little Whinging, Surrey, England, Great Britain");
        ...
        // 2.1 Create book
        System.out.println("\n-- 2.1 Book --");
        Book book = new Book((short) 1, true, "na", "na", "1984", "George Orwell",
                1949, "Secker & Warburg", "Dystopian fiction");
        Book book2 = new Book((short) 1, true, "na", "na", "1984", "George Orwell",
                1949, "Secker & Warburg", "Dystopian fiction");
        ...
        System.out.println("\n-- 2.2 AudioBook --");
        AudioBook audiobook = new AudioBook((short) 2, true, "na", "na",
                "To Kill a Mockingbird", "Harper Lee", 1960, "J. B. Lippincott & Co",
                "Southern Gothic, Bildungsroman", 123456789);
        AudioBook audiobook2 = new AudioBook((short) 2, true, "na", "na",
                "To Kill a Mockingbird", "Harper Lee", 1960, "J. B. Lippincott & Co",
                "Southern Gothic, Bildungsroman", 123456789);
        ...
        System.out.println("\n\n--- El Fin -- 結束 -- La Fin -- Кінець -- Das Ende -- The End  -- La Fine -- O Fim " +
                "-- 終わり ---");
    }
}
